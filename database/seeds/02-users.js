  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        {email: "melissa@beedev-services.com", username: "beedev", fullName: "Melissa Longenberger", password: "$2a$10$cMtqYbWJKLSF1r1j2K3nA.Zv1O.epohHna/7zpkchH3FBPdGRBCQC", role: "Admin"},
